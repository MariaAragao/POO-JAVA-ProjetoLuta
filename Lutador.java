...
public class Lutador {
    ...
    public void apresentar(){
        ...
        System.out.println("Diretamente de : " + this.getNacioalidade());
    ...
    public Lutador(String nome, String nacioalidade, int idade, float altura, float peso, int vitorias, int derrotas, int empates) {
        this.nome = nome;
